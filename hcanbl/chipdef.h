...
//  #define PAGESIZE 64        // Size in Bytes
  ...
  #define sig_byte3 0x1E //Vendor Code
  #define sig_byte2 0x95 //Part Family
  #define sig_byte1 0x02 //Part Number
...
//  #define PAGESIZE 128       // Size in Bytes
  ...
  #define sig_byte3 0x1E //Vendor Code
  #define sig_byte2 0x96 //Part Family
  #define sig_byte1 0x09 //Part Number

  #define devtype 0x73       //TODO Mega644 device code

  #ifdef _B128
    #define APP_PAGES ((2*32768UL / SPM_PAGESIZE)- (2*128 / SPM_PAGESIZE ))
    #define APP_END APP_PAGES * SPM_PAGESIZE
  #endif
  #ifdef _B256
    #define APP_PAGES ((2*32768UL / SPM_PAGESIZE)- (2*256 / SPM_PAGESIZE ))
    #define APP_END APP_PAGES * SPM_PAGESIZE
  #endif
  #ifdef _B512
    #define APP_PAGES ((2*32768UL / SPM_PAGESIZE)- (2*512 / SPM_PAGESIZE ))
    #define APP_END APP_PAGES * SPM_PAGESIZE
  #endif
   #ifdef _B1024
    #define APP_PAGES ((2*32768UL / SPM_PAGESIZE)- (2*1024 / SPM_PAGESIZE ))
    #define APP_END APP_PAGES * SPM_PAGESIZE
  #endif
  #ifdef _B2048
    #define APP_PAGES ((2*32768UL / SPM_PAGESIZE)- (2*2048 / SPM_PAGESIZE ))
    #define APP_END APP_PAGES * SPM_PAGESIZE
  #endif
